...
import { User, LogIn, ArrowLeft, LogOut } from 'lucide-react';
        ...
        <div className="flex justify-between items-center h-16 w-100">
          <div className="flex items-center space-x-4">
            {showBackButton && (
              <button
                onClick={onBackClick}
                className="p-2 text-gray-600 hover:text-teal-600 transition-all duration-300 hover:bg-teal-50 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-300"
              >
                <ArrowLeft className="h-5 w-5 transition-transform duration-300 hover:scale-110" />
              </button>
            )}
